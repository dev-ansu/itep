...
import { useState, MouseEvent, ChangeEvent, useRef, KeyboardEvent } from "react";
...
const Cursos = ()=>{
    ...
    const {handleSubmit, register, reset, formState:{errors}} = useForm<CursosData>({
        mode:"onChange",
    ...
    const insert = async(data: CursosData)=>{
        if(!cursoIMage){
    ...
    return(
        <div className="p-4">
            <h1>Cursos</h1>
            <form onSubmit={handleSubmit(insert)} className="flex flex-col w-full gap-4 mt-8">
                <div className="flex gap-2 h-48">
                    ...
                    <div className="h-48  w-full flex items-center justify-center">
                        <div className="w-64 h-64 relative">
                            ...
                            <img className="h-full object-cover" src={cursoIMage.previewUrl} />
                        </div>
                    </div>
                    }
                </div>
